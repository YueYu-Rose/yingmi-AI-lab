  ...
  return (
    <aside className="w-[260px] shrink-0 border-r border-bolt-light-5 bg-bolt-light flex flex-col h-full">
      ...
      <nav className="flex-1 overflow-y-auto p-3">
        ...
        <div data-testid="personal-space-header" className="mt-5 mb-1 px-2 min-h-7 flex items-center gap-2">
        ...
        {filteredPersonal.length === 0 ? (
          ...
          filteredPersonal.map((proj) => (
            <button
              ...
              className="w-full flex items-center px-2.5 py-2 rounded-lg text-[13.5px] text-bolt-light-9 hover:bg-bolt-light-3 hover:text-bolt-light-11 transition-all duration-150"
            >
